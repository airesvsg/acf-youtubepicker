...
= 3.2.1 =
* fix thumbnail protocol ( https://github.com/airesvsg/acf-youtubepicker/issues/19 )

= 3.2.0 =
* bugfix error preview over https ( https://github.com/airesvsg/acf-youtubepicker/issues/16 )
